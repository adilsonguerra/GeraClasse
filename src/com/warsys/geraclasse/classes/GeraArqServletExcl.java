...
public class GeraArqServletExcl {
	
	boolean geracao_ok = false;
	
	public GeraArqServletExcl(String nomeClasse,String nomeEmpSist, Registros[] regConvertido){
			...
			try{
				...
				a.escrever("  ",0);
				a.escrever("public class "+GeraClasse.nomeServletExclusao+" extends HttpServlet {",0);
				a.escrever("",0);
				...
				a.escrever("                          throws ServletException, IOException {",0);
				a.escrever("",0);
				a.escrever("   System.out.println("+'\"'+"Entrou no "+GeraClasse.nomeServletExclusao+"..."+'\"'+");",0);
				a.escrever("",0);				
				...
				if (temCampoData){
					...
					a.escrever("     System.out.println(" +'\"'+"Ocorreu um erro ao EXCLUIR o registro !"+'\"'+"+  e.getMessage());",0);
               ...
               a.escrever("      out.println(MontaPgErro(\"Ocorreu um erro ao EXCLUIR! Verifique se dado selecionado está correto.\",e.getMessage()));",0);              
            ...
            a.escrever("      out.println(MontaPgErro(\"Ocorreu um erro ao EXCLUIR! Verifique se dado selecionado está correto.\",e.getMessage()));",0);              
				...
				a.escrever("	   out.println("+'\"'+"</HTML>"+'\"'+");",0);
				a.escrever("	   out.close();",0);
				a.escrever("   }",0);
				a.escrever("",0);
				a.escrever("   catch (Exception e) {",0);
				a.escrever("     System.out.println(" +'\"'+"Ocorreu um erro ao EXCLUIR !"+'\"'+"+  e.getMessage());",0);	
				a.escrever("",0);
				a.escrever("   	// acerta tipo MIME para a resposta",0);
				a.escrever("   	response.setContentType("+'\"'+"text/html"+'\"'+");",0);
				a.escrever("",0);
            ...
            a.escrever("      out.println(MontaPgErro(\"Ocorreu um erro ao EXCLUIR! Verifique se dado selecionado está correto.\",e.getMessage()));",0);              
				...
				a.escrever("   dispatcher.forward(request,response);",0);
				a.escrever("",0);
				a.escrever("System.out.println("+'\"'+"...saiu do "+GeraClasse.nomeServletExclusao+'\"'+");",0);
				a.escrever("",0);				
