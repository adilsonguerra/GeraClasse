...
public class GeraArqConsultaJsp {
   
   boolean geracao_ok = false;
   
   public GeraArqConsultaJsp(String nomeJsp,String nomeEmpSist, Registros[] regConvertido){

         boolean temCampoData = false;
         String aux="";
         char chave = ' ';
         System.out.println("----------------------------------------------------");
         System.out.println("Estou no criarConsultaJsp, recebi o parametro->"+nomeJsp);
         ...
         try{
            ...
            for(int i=0;i<regConvertido.length;i++){
               ...
               if (!regConvertido[i].getRepositorio().equals("null")){
                  ...
                  a.escrever("<%@ page import="+'\"'+"com."+nomeEmpSist+".bean."+classeRep+'\"'+"%>",0);
                  a.escrever("<%@ page import="+'\"'+"com."+nomeEmpSist+".db."+classeRep+"DB"+'\"'+"%>",0);
               }
            ...
            //Botão antigo
            //a.escrever("    <td onmousemove="+'\"'+"bgColor='#FFAD5B'"+'\"'+" onmouseout="+'\"'+"bgColor='#C9C9C9'"+'\"'+" onclick="+'\"'+"return cmdLogin_onclick('Con"+GeraClasse.nomeBean+"')"+'\"'+" class=BotaoAzul nowrap=0 align="+'\"'+"center"+'\"'+" width="+'\"'+"50"+'\"'+" bgColor=#C9C9C9 >Consultar</td>",0);
            //a.escrever("    <td onmousemove="+'\"'+"bgColor='#FFAD5B'"+'\"'+" onmouseout="+'\"'+"bgColor='#C9C9C9'"+'\"'+" onclick="+'\"'+"return cmdLogin_onclick('Inc"+GeraClasse.nomeBean+"')"+'\"'+" class=BotaoAzul nowrap=0 align="+'\"'+"center"+'\"'+" width="+'\"'+"50"+'\"'+" bgColor=#C9C9C9 >Incluir</td>",0);
